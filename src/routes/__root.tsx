...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "SaveurZéro — Donnez une seconde vie aux bons repas" },
      { property: "og:description", content: "La marketplace marocaine qui sauve les bons repas du gaspillage." },
